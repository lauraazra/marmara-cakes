...
export default function BrandValues({ data, loading }) {
  ...
  if (loading)
    return <p className="text-center py-10">Loading brand value...</p>;
      ...
      {data.map((value, index) => {
        ...
        return (
          <motion.div
            ...
            className="relative group p-8 bg-card-site rounded-3xl border border-border-site shadow-md shadow-shadow-primary overflow-hidden will-change-transform"
          >
            <div
            ...
            <div className="relative z-10 space-y-5">
              ...
              <h4 className="text-2xl font-bold leading-snug">{value.title}</h4>
