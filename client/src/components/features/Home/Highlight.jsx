...
export default function Highlight() {
  ...
  return (
    <motion.div
      ...
      variants={boxReveal}
      className="highlight-brand grid grid-cols-3 mx-auto w-full"
    >
      {/* Box 1 */}
      <div className="highlight-box text-center border-r border-border-site">
        <p className="text-2xl font-bold text-text-site md:text-4xl">
          <Counter from={0} to={6} duration={1.5} />
        </p>
        <p className="text-xs uppercase tracking-wider text-text-site md:text-sm mt-1">
          Branches
        </p>
      </div>
